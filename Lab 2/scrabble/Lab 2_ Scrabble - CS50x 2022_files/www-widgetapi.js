...
;function L(a,b,c){a||(a=md);md=null;var d=this.constructor.g||0,e=0<d,f=this.constructor.h,g=!1;if(!a){var h=f?[f]:[];Ec(h,48);a=h;h=!0}else if(h=!!(Gc(a)&16))g=Gc(a),Hc(a,g|32),g=!!(g&32);e&&0<a.length&&Oc(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.S=(f?0:-1)-d;this.g=void 0;this.o=a;a:{f=this.o.length;d=f-1;if(f&&(f=this.o[d],Oc(f))){this.D=f;b=Object.keys(f);0<b.length&&db(b,isNaN)?this.W=Number.MAX_VALUE:this.W=d-this.S;break a}void 0!==b&&-1<b?(this.W=Math.max(b,d+1-this.S),this.D=void 0):
this.W=Number.MAX_VALUE}if(!e&&this.D&&"g"in this.D)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(c)for(e=h&&!g?Jc:Ic,b=0;b<c.length;b++)h=c[b],(g=$c(this,h))?Array.isArray(g)&&e(g):I(this,h,Qc,!1,!0)}
